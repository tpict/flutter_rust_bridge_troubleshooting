...
class HelloWorldImpl implements HelloWorld {
  ...
  factory HelloWorldImpl(ExternalLibrary dylib) => HelloWorldImpl.raw(HelloWorldPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory HelloWorldImpl.wasm(FutureOr<WasmModule> module) => HelloWorldImpl(module as ExternalLibrary);
